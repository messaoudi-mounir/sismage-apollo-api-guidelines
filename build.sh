#!/usr/bin/env bash
# Script to build Apollo RESTful Guidelines (static HTML, PDF)
...
mv ${BUILD_DIR}/index.pdf ${BUILD_DIR}/apollo-guidelines.pdf
mv ${BUILD_DIR}/index.epub ${BUILD_DIR}/apollo-guidelines.epub
