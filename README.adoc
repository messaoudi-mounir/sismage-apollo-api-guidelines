...
https://travis-ci.org/zalando/restful-api-guidelines[https://github.com/fabref-34/smg-apollo-restful-api-guidelines/workflows/build html from adocs to gh-pages branch/badge.svg?branch=master[Build Status]]
