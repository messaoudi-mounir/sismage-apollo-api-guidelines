...
:creator: SISMAGE and APOLLO teams
:producer: Asciidoctor
:keywords: SISMAGE, Apollo, Guidelines, RESTful, API, Events, Schema
...
//*APOLLO-Commented line* Event Scheme Out of Apollo Scope  = SISMAGE & Apollo RESTful API and Event Scheme Guidelines
= SISMAGE & Apollo RESTful API Guidelines
=== Adapted from https://github.com/zalando/restful-api-guidelines

image::assets/logo_CIG_APOLLO.png[API Guild Logo]

//*APOLLO-Commented line* No Other formats yet Other formats: link:apollo-guidelines.pdf[PDF], link:apollo-guidelines.epub[EPUB3]

HTML Conversion Status : 
https://github.com/f-fabre/sismage-apollo-restful-api-guidelines/actions[image:https://github.com/f-fabre/sismage-apollo-restful-api-guidelines/workflows/html_conversion/badge.svg?branch=master[Build Status]]

include::chapters/key-principles.adoc[]
...
include::chapters/api-design-review-process.adoc[]
...
//*APOLLO-Commented line* Out of Apollo Scope include::chapters/proprietary-headers.adoc[]
include::chapters/api-operation.adoc[]
//*APOLLO-Commented line* Out of Apollo Scope include::chapters/events.adoc[]
