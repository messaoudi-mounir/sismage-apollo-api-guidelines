...
make it discoverable for the group via our https://developper-np.apollo.total/[Apollo API Portal
[internal link]].
...
https://developper-np.apollo.total/[Apollo API Portal [internal link]] 
