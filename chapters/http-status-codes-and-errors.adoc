  ...
  default:
    ...
    content:
      "application/problem+json":
        schema:
          $ref: 'https://raw.githubusercontent.com/fabref-34/sismage-apollo-api-guidelines/gh-pages/models/problem.yaml'
----
...
[#220]
== {MAY} use most specific HTTP status codes
////
*APOLLO-Commented paragraph* MAY and not MUST in APOLLO context 
...
////
You may use the most specific HTTP status code when returning information 
about your request processing status or error situations.


[#152]
== {SHOULD} use code 207 for batch or bulk requests
////
...
[#153]
== {SHOULD} use code 429 with headers for rate limits
////
*APOLLO-Commented paragraph* SHOULD and not MUST in APOLLO context 
...
////
*APOLLO-Commented paragraph* modified in APOLLO context 
The Open API schema definition of the Problem JSON object can be found
https://zalando.github.io/problem/schema.yaml[on Zalando github]. You can
...
The Open API schema definition of the Problem JSON object can be found
https://zalando.github.io/problem/schema.yaml[on Zalando github] and is
reported below :

[source,yaml]
----
include::../models/problem.yaml[]
----
...
responses:
  503:
    ...
    content:
      "application/problem+json":
        schema:
          $ref: 'https://fabref-34.github.io/sismage-apollo-api-guidelines/problem.yaml#/Problem'
----
