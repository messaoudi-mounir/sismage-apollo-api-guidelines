...
the URL. In addition, size limits on query parameters and headers are not
...
[#149]
== {SHOULD} fulfill common method properties
////
...
* `name=Apollo`, to query for elements based on property equality
...
[#226]
== {SHOULD} document implicit filtering
////
*APOLLO-Commented paragraph* SHOULD and not MUST in APOLLO context 
