...
[#1004]
== {SHOULD} use common objects  
APIs are encouraged to include a reference to a global schema for main subsurface objects such as coordinates...
...
allows API client developers to build up a common understanding of SISMAGE & Apollo's
